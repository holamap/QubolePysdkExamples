"""
This is the sample code used for submitting a Qubole Zeppelin Notebook (SparkCommand) and getting the result back to local file.
...
def execute_notebook(notebookId):
    if notebookId is None or notebookId == 0:
        return None
    cmd = SparkCommand.create(note_id=notebookId)
    query_id = str(cmd.id)
...
if __name__ == '__main__':
    ...
    get_results(execute_notebook(39576))
    #39576 is example
